...
A Perl Moose class that wraps the Samtools suite of tools using Moose Roles found in this package.

	use NGS::Tools::Samtools;

	my $obj = NGS::Tools::Samtools->new();
