package NGS::Tools::Samtools::Role::Core;
use Moose::Role;
...
NGS::Tools::Samtools::Role::Core

=head1 SYNOPSIS

A Perl Moose role containing core attributes and methods.

=head1 ATTRIBUTES AND DELEGATES

=head2 $obj->samtools

Attribute for the full path to the samtools binary.  Default: samtools
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc NGS::Tools::Samtools::Role::Core
...
1; # End of NGS::Tools::Samtools::Role::Core
